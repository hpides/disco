...
public class DistributiveWindowMergerTest extends WindowMergerTestBase {
    ...
    @Test
    void testTriggerOneChild() {
        windows.add(tumblingWindow);
        aggregateFunctions.add(sumFunction);
        int numChildren = 1;
        DistributiveWindowMerger<Integer>
                windowMerger = new DistributiveWindowMerger<>(numChildren, windows, aggregateFunctions);
    ...
    @Test
    void testTriggerOneChildTwoAggFns() {
        windows.add(tumblingWindow);
        aggregateFunctions.add(sumFunction);
        aggregateFunctions.add(sumFunction);
        int numChildren = 1;
    ...
    @Test
    void testTriggerOneChildTwoWindows() {
        windows.add(tumblingWindow);
