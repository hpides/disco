...
public class AlgebraicMergeFunction<PartialType extends AlgebraicPartial<PartialType, ResultType>, ResultType> implements AggregateFunction<PartialType, PartialType, ResultType> {
    @Override
